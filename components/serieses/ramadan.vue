                ...
                <div class="row">
                    <div class="col-md-2 flex">
                        ...
                        <div class="block-type">
                            <nuxt-link to="/ramadan">
             <svg id="line" height="35px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="m62 49h-1v-22h1a1 1 0 0 0 0-2h-1.08a7 7 0 0 0 -6.92-6 5 5 0 0 1 -5-5 1 1 0 0 0 -2 0 5 5 0 0 1 -5 5 7 7 0 0 0 -6.92 6h-1.08a1 1 0 0 0 0 2h1v22h-1a1 1 0 0 0 0 2h1.08a7 7 0 0 0 6.92 6 5 5 0 0 1 5 5 1 1 0 0 0 2 0 5 5 0 0 1 5-5 7 7 0 0 0 6.92-6h1.08a1 1 0 0 0 0-2zm-21 0h-4v-22h4zm6 0h-4v-22h4zm6 0h-4v-22h4zm6 0h-4v-22h4z" fill="#fff"/><g fill="#ffa500"><path d="m50.68 22a1 1 0 0 0 -2 0 16 16 0 1 1 -18.68-18.71 1 1 0 0 0 0-2 25.43 25.43 0 0 0 -4-.29 25 25 0 1 0 25 25 25.43 25.43 0 0 0 -.32-4zm-24.68 27a23 23 0 0 1 -1.31-46 18 18 0 1 0 24.31 24.31 23 23 0 0 1 -23 21.69z"/><path d="m26 44a18 18 0 0 1 -18-18 1 1 0 0 0 -2 0 20 20 0 0 0 20 20 1 1 0 0 0 0-2z"/><path d="m23.36 14.9a1 1 0 0 0 -.56 1.7l4.75 4.63-1.12 6.54a1 1 0 0 0 1.45 1.05l5.87-3.08 5.87 3.08a1 1 0 0 0 1.45-1.05l-1.07-6.54 4.7-4.63a1 1 0 0 0 -.56-1.7l-6.56-1-2.93-5.9a1 1 0 0 0 -1.8 0l-2.93 5.94zm8.12.4 2.27-4.6 2.25 4.6a1 1 0 0 0 .75.55l5.08.74-3.67 3.58a1 1 0 0 0 -.29.88l.87 5.06-4.54-2.39a1 1 0 0 0 -.94 0l-4.54 2.39.87-5.06a1 1 0 0 0 -.29-.88l-3.67-3.58 5.08-.74a1 1 0 0 0 .77-.55z"/></g></svg>
...
<g>
                    ...
                    <div class="col-md-10">
                        ...
                        <div class="categories">
                            <ul ref="collapsebtns" id="colla4" class="sub">
                                <!-- Item .1 -->
                                <li>
...
<script>
import SliderList from '~/components/serieses/ramadanList.vue';
export default {
    data() {
        return {
    ...
    methods: {
        Collapse(e) {
            ...
            this.CollapseActive = name;
              var element = document.getElementById("colla4");
                 element.classList.remove("show");
        },
        ShowNav(e){
             var element = document.getElementById("colla4");
