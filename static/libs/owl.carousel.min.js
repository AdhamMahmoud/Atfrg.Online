        ...
        e.Workers = [{
            ...
            run: function() {
                for (
                    ...
                    d = f[c - 1] || 0,
                    e = this._widths[this.relative(c)] + this.settings.margin + 40,
                    f.push(d + e * a);
                this._coordinates = f
            }
        }, {
        ...
        e.prototype.width = function(a) {
            switch (a = a || e.Width.Default) {
                ...
                case e.Width.Outer:
                    return this._width;
                default:
                    return this._width - 2 * this.settings.stagePadding + this.settings.margin + 40
            }
        },
            ...
            3 !== b.which && (
                ...
                (d = this.$stage.position(), d = {
                    x: this.settings.rtl ?
                        d.left + this
                        .$stage
                        .width() - this.width() + this.settings.margin : d.left,
                    y: d.top
                }),
                this.is("animating") && (
                    a.support.transform ?
                ...
                "initialized.owl.carousel change.owl.carousel resized.owl.carousel": a.proxy(
                    function(b) {
                        if (b.namespace && this._core.settings && this._core.settings.lazyLoad && (b.property && "position" == b.property.name || "initialized" == b.type)) {
                            ...
                            for (
                                c.lazyLoadEager > 0 && (e += c.lazyLoadEager, c.loop && (g -= c.lazyLoadEager, e++)); f++ < e;
                            )
